...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={"ตะกร้าสินค้า"} pages={["ตะกร้าสินค้า"]} />
      </section>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="font-medium text-dark text-2xl">ตะกร้าสินค้า</h2>
              <button className="text-blue">ล้างตะกร้าสินค้า</button>
            </div>
                ...
                <div className="min-w-[1170px]">
                  ...
                  <div className="flex items-center py-5.5 px-7.5">
                    ...
                    <div className="min-w-[275px]">
                      <p className="text-dark">จำนวน</p>
                    </div>

                    <div className="min-w-[200px]">
                      <p className="text-dark">ยอดรวม</p>
                    </div>

                    <div className="min-w-[50px]">
                      <p className="text-dark text-right">จัดการ</p>
                    </div>
                  </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <p className="pb-6">ตะกร้าสินค้าว่าง</p>
