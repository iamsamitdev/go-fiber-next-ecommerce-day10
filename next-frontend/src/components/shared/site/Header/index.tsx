...
import { menuData } from "@/components/shared/site/Header/menuData"
import Dropdown from "@/components/shared/site/Header/Dropdown"
              ...
              <form>
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    {/* <!-- divider --> */}
                    <span className="absolute left-0 top-1/2 -translate-y-1/2 inline-block w-px h-5.5 bg-gray-300"></span>
                    <input
                      ...
                      autoComplete="off"
                      className="w-full rounded-r-[5px] bg-gray-1 !border-l-0 border border-gray-3 py-[10px] pl-4 pr-10 outline-none ease-in duration-200"
                    />
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <Link href="/auth/signin" className="flex items-center gap-2.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <button className="flex items-center gap-2.5 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-custom-sm text-dark">$0</p>
                  </div>
                </button>
              </div>
