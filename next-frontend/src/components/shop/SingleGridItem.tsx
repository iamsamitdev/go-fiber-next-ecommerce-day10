...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  // Simple handlers for demonstration
  const handleQuickViewUpdate = () => {
    console.log("Quick view clicked for:", item.title)
  }
  ...
  const handleItemToWishList = () => {
    console.log("Add to wishlist clicked for:", item.title)
  }

  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-white shadow-1 min-h-[270px] mb-4">
        <Image src={item.imgs?.previews?.[0] || "/images/products/product-1-bg-1.png"} alt="" width={250} height={250} />
