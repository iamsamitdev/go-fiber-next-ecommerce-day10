...
import CustomSelect from "@/components/shared/site/Header/CustomSelect"
...
const ShopWithSidebar = () => {
  ...
  const options = [
    { label: "สินค้ามาใหม่", value: "0" },
    { label: "สินค้าขายดี", value: "1" },
    { label: "สินค้าอื่นๆ", value: "2" },
  ]
  ...
  return (
    <>
      <Breadcrumb
        title={"สินค้าทั้งหมด"}
        pages={["ร้านค้า", "/", "ร้านค้าแบบมีตัวกรอง"]}
      />
      <section className="overflow-hidden relative pb-20 pt-5 lg:pt-12 xl:pt-12 bg-[#f3f4f6]">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p>การกรอง:</p>
                      <button className="text-blue">ล้างค่าทั้งหมด</button>
                    </div>
                  </div>
              ...
              <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p>
                      แสดง <span className="text-dark">9 of 50</span>{" "}
                      รายการ
                    </p>
                  </div>
